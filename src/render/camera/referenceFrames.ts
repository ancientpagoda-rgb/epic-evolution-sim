...
export const REFERENCE_FRAMES: Readonly<Record<ScaleDomain, ReferenceFrameDefinition>> = {
  ...
  planetary: {
    ...
    unitLabel: '10³ km',
    metersPerUnit: 1e6,
    rebaseThreshold: 10_000,
    near: 0.002,
    far: 30_000,
    home: { position: [0, 3.5, 15], target: [0, 0, 0] },
    entry: { position: [0, 8, 30], target: [0, 0, 0] },
    exit: { position: [0, 0.9, 4.5], target: [0, 0, 0] },
  },
  surface: {
    id: 'surface',
    ...
    rebaseThreshold: 5_000,
    near: 0.001,
    far: 20_000,
    home: { position: [0, 2.2, 11], target: [0, 0, 0] },
    entry: { position: [0, 7, 26], target: [0, 0, 0] },
    exit: { position: [0, 0.6, 3.2], target: [0, 0, 0] },
  },
  microscopic: {
    id: 'microscopic',
