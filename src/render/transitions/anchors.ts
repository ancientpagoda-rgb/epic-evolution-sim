...
export const TRANSITION_ANCHORS: readonly TransitionAnchor[] = [
  ...
  },
  {
    from: 'planetary',
    to: 'surface',
    label: 'selected generated world → atmosphere and surface',
    continuity: 'One surviving low-gas Phase-5 world becomes the parent frame for the later surface environment.',
    parentAnchor: [0, 0, 0],
    childAnchor: [0, 0, 0],
  },
  {
